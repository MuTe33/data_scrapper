...
query TopSalesLast24h {
  sales(
    filter: {
      ...
      timeFilter: {lookbackHours: 72}, saleTypes: [OPENSEA_SINGLE_SALE, OPENSEA_BUNDLE_SALE, SEAPORT_SALE, FOUNDATION_SALE, RARIBLE_SALE, SUPERRARE_SALE, CRYPTOPUNKS_SALE,ZORA_V2_AUCTION_SALE, ZORA_V3_ASK_SALE, NOUNS_AUCTION_SALE, LIL_NOUNS_AUCTION_SALE, ZEROX_SALE]
    }
